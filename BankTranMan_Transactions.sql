...
CREATE TABLE TRANSACTIONS(
    ...
    Debit_Account   number(30),
    Credit_Account  number(30),
    IFSC_Code_Debit varchar(11),
    IFSC_Code_Credit varchar (11),
...
insert into TRANSACTIONS(Tansaction_ID, Debit_Account,Credit_Account,IFSC_Code_Debit,IFSC_Code_Credit, Amount,  Transaction_date,Message,Status) Values
(1103876940301, 53153834006064000, 3690859741294280, 'DMDD0101022','DMDD0454500','40.00',DATE '2021-04-11','Amount $40 Transferred', 'Success');
...
insert into TRANSACTIONS(Tansaction_ID, Debit_Account,Credit_Account,IFSC_Code_Debit,IFSC_Code_Credit, Amount,  Transaction_date,Message,Status) Values
(1203876940306, 13719713158835300, 1086643758945400, 'DMDD0454500','DMDD0101022','120.00',DATE '2021-02-29','sent $120', 'Success');
...
insert into TRANSACTIONS(Tansaction_ID, Debit_Account,Credit_Account,IFSC_Code_Debit,IFSC_Code_Credit, Amount,  Transaction_date,Message,Status) Values
(1103876940313, 53153834006064000, 3690859741294280, 'DMDD0101022','DMDD0454500','700.00',DATE '2021-02-29','Amount $700 Transferred', 'Success');
...
Create view myView1 as Select Amount,Message,Status from TRANSACTIONS where Amount > 400;
Select * from myView1;